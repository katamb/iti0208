  ...
  <div class="container-fluid">
    <div class="row justify-content-center">
      <div class="col-xl-5 col-lg-6 col-md-8 col-sm-11">
        ...
        <br>
        <p  class="border-top border-dark"><i>If You forgot Your password, enter Your username here and press 'Submit'.
          You will be sent a link which you can use to reset Your password.</i></p>

        <form id="post-form" class=" border-bottom border-dark" @submit.prevent="processForm">
